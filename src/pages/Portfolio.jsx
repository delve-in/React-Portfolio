    ...
    return (
        <div className="flex" >
            <div className="projects">
                ...
                <img className="logo" src="../../public/Movie1.jpg"></img>
                ...
                <div className="projects">
                <img className="logo" src="../../public/1Blog.jpg"></img>
                ...
                <div className="projects">
                <img className="logo" src="../../public/1text.jpg"></img>
                ...
                <div className="projects">
                <img className="logo" src="../../public/1Quiz.jpg"></img>
                ...
                <div className="projects">
                <img className="logo" src="../../public/1Pass.jpg"></img>
                ...
                <div className="projects">
                <img className="logo" src="../../public/1Weather.jpg"></img>
